...
import com.eng.renan.clienteconvertidodesktop.util.relatorio.JRPrintPreview;
...
public class Report {
  ...
  private Task<JasperPrint> createReportTask(final Map<String, Object> paramMap, final JRBeanCollectionDataSource dataSource) {
