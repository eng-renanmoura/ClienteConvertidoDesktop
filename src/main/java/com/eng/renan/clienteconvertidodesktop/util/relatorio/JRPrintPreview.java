package com.eng.renan.clienteconvertidodesktop.util.relatorio;
...
public class JRPrintPreview extends Stage {
  ...
  private void initComponents() {
    ...
    txtGoTo.setOnAction(new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent t) {
          onGoToTextChanged();
        }
    ...
    btnActualSize.setOnAction(new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent t) {
    ...
    btnFitPage.setOnAction(new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent t) {
        if (((ToggleButton) t.getSource()).isSelected())
            onFitPagePressed();
    ...
    btnFitWidth.setOnAction(new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent t) {
        if (((ToggleButton) t.getSource()).isSelected())
    ...
    cmbZoom.setOnAction(new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent t) {
